...
namespace Common.Repositories
{
    ...
    {        
        ...
        public List<DataAccess.Models.Action> Get(string value)
        {
            //roles di application context class
            var get = applicationContext.Actions.Where(x => (x.Name.Contains(value) || Convert.ToString(x.Id).Contains(value)) && x.IsDelete == false).ToList();
            return get;
        }
